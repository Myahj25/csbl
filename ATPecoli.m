...
% doing single reaction and gene deletion with ATP synthase as the objective function
...
%setting ATP synthase as the objective function 
model = changeObjective(model,'ATPS4r');
...
%% doing single reaction/gene deletion for anaerobic
