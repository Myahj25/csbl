...
function [results,significant_changes] = calculateFluxFoldChanges(dataTable, modelName1, modelName2, varargin)
    ...
    figure;
                ...
                % Label points with |log2 fold change| > 12
                high_change_idx = abs(results.Log2FoldChange) > 12;
                ...
                % Set figure details
                xlabel('Flux in CAF Model');
                ylabel('Flux in NF Model');
                title('Reaction Flux Comparison with Log2 Fold Change (Names are shown for FC>12)');
                colorbar;
                hold off;
